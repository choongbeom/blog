      ...
      content:[
        {
          title: "SQL Commands",
          type: "P",
          scr: "DDL(CREATE, ALTER, DROP, RENAME, TRUNCATE, CONNENT), DML(SELECT, INSERT, UPDATE, DELETE, MERGE, CALL, EXPLAIN PLAN, LOCK TABLE), DCL(GRANT, REVOKE), TCL(COMMIT, ROLLBACK, SAVEPOINT, SET TRANSACTION)"
        },
        {
          title: "SQL-DDL",
          type: "P",
        ...
        }, 
        {
          ...
          scr: {
            ...
            desserts: [
              {
                command: 'CREATE',
                function: '스키마, 도메인, 테이블, 뷰, 인덱스를 정의',
              },
              {
                command: 'ALTER',
                function: '테이블에 대한 정의를 변경',
              },
              {
                command: 'DROP',
                function: '스키마, 도메인 테이블, 뷰, 트리거, 인덱스를 제거',
              },
            ]
          }
        },                
...
스키마의 식별을 위한 스키마 이름고 해당 스키마의 소유권자나 허가권자를 정의한다.`
        },        
        {
          title: "",
          type: "C",
          scr: `CREATE SCHEMA 스키마명 AUTHORIZATION 사용자_ID;`
        },
        {
          title: "CREATE DOMAIN",
          type: "P",
  ...
  [DEFAULT 기본값]
  	[CONSTRAINT 제약조건명 CHECK (범위 값)];`
        },
        {
          title: "",
          type: "P",
          scr: "SQL에서 []표시, 즉 대괄호로 묶인 부분은 생략이 가능하다는 표시이다."
        },        
        {
          title: "CREATE TABLE",
          type: "P",
  ...
  (속성명 데이터_타입 [NOT NULL] ...
  	[, PRIMARY KEY (기본키_속성명 ...)]
        ...
        },                
        {
          title: "CREATE VIEW",
          type: "P",
          scr: "뷰는 하나 이상의 기본 테이블로부터 유도되는 이름을 갖는 가상 테이블(Virtual Table)로, CREATE VIEW는 뷰를 정의하는 명령문이다."
        },        
        {
          title: "",
          type: "C",
...
AS SELECT문;`
        },          
        {
          title: "CREATE INDEX",
          type: "P",
          scr: "인덱스는 검색을 빠르게 하기 위해 만든 보조적인 데이터 구조이며, CREATE INDEX는 인덱스를 정의하는 명령문이다."
        },        
        {
          title: "",
          type: "C",
...
DROP CONSTRAINT 제약조건명;`
      ...
      reference: [
        {
          title: '윤자이 기술블로그',
          url: "https://ooeunz.tistory.com/8",
        }
      ]
    }
  },

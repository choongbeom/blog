...
엔티티 매니저 내부에 영속성 컨텍스트(Persistence Context)라는 걸 두어서 엔티티들을 관리한다.`
        },
        {
          title: "",
          type: "I",
          scr: "https://github.com/choongbeom/choongbeom.github.io/blob/master/_posts/IMG/3E.png?raw=true",
        },
        {
...
하지만 프로그램을 끄기도 전에 엔티티 매니저를 초기화 및 종료 시키는 코드를 만나면 해당 영속성 컨텍스트는 소멸된다.`
        ...
        {
          title: "엔티티 매니저와 영속성 컨텍스트의 엔티티 관리",
          type: "P",
          scr: 
...
따라서 동일한 엔티티 매니저 팩토리를 공유해서 사용하려면 싱글턴 인스턴스나 의존성 주입 등등을 통해 개발자의 의식적인 노력이 필요하다.`
      ...
      reference: [
        {
          title: '오늘도 끄적끄적',
          url: "https://perfectacle.github.io/2018/01/14/jpa-entity-manager-factory/",
        }
      ]
    }
  },

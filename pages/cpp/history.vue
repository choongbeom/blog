...
제가 정리를한 자료는 아니지만, 아주 정리가 잘된 사이트를 공유 합니다.
저도 종종 참고하는 사이트 입니다.`
        }
      ],
      source: [
        {
          title: '모두의 코드',
          url: "https://milooy.wordpress.com/2017/06/21/working-together-with-github-tutorial/",
        },
        {
          title: '프로그래머스',
          url: "https://backlog.com/git-tutorial/kr/",
        }
      ],
      reference: [
      ]

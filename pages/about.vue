<template>
  <v-container>
    ...
    Blog: https://choongbeom.github.io/
    GitHub: https://github.com/choongbeom/
    ...
    망치쾅쾅쾅(2013.12 ~ 2014.09)
    아케이드 게임 시나리오 작성
    Unity3D를 이용하여 게임 디자인/개발
    현재 운영하지 않음
    산수의 모험(2014.06 ~ 2014.09)
    교육 게임 시나리오 작성
    Unity3D를 이용하여 게임 디자인/개발
    현재 운영하지 않음
    Skill
    ...
    논문: 적외선 조명 카메라를 이용한 동공 마우스 시스템 (An Eye Mouse System Using an Infrared Illumination Camera)
  </v-container>
</template>
